    ...
    return (
        <div className="container">
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",margin:"0 16px"}}>
                <p style={{fontSize:"32px"}}>Insumos</p>
            ...
            </div>
            {
                articulosInsumos.map((insumo: IArticuloInsumo) => {
                    return (
                        <div className="itemGrilla" key={insumo.id}>
                            ...
                            <div>{insumo.precioVenta}</div>
                            <div style={{display:"flex", alignItems:"center"}}>
                                <a style={{marginRight:"1rem"}} href={"insumos/save/" + insumo.id}>
                                ...
                                <button className="btn btn-danger" onClick={() => handleDelete(insumo.id)}>Eliminar</button>
